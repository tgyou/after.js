...
export declare class MergeMapOperator<T, I, R> implements Operator<T, I> {
    ...
    private concurrent;
    constructor(project: (value: T, index: number) => ObservableInput<I>, resultSelector?: ((outerValue: T, innerValue: I, outerIndex: number, innerIndex: number) => R) | undefined, concurrent?: number);
...
export declare class MergeMapSubscriber<T, I, R> extends OuterSubscriber<T, I> {
    ...
    constructor(destination: Subscriber<I>, project: (value: T, index: number) => ObservableInput<I>, resultSelector?: ((outerValue: T, innerValue: I, outerIndex: number, innerIndex: number) => R) | undefined, concurrent?: number);
