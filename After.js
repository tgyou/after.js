...
var Afterparty = /** @class */ (function (_super) {
    ...
    Afterparty.prototype.render = function () {
        var _this = this;
        var _a = this.props, location = _a.location, restData = __rest(_a, ["location"]);
        var routes = makeRoutes_1.default(this.props.routes, this.props.id);
        var data = this.props.data || {};
        var children = (React.createElement(react_router_dom_1.Switch, { location: location }, routes.map(function (r, i) { return (React.createElement(react_router_dom_1.Route, { key: r.id || "route--" + i, path: r.path, exact: r.exact, location: location, render: function (props) {
        ...
        if (this.props.render) {
            var _b = this.props, render = _b.render, props = __rest(_b, ["render"]);
            return render(__assign({}, props, { children: children }));
        }
        else {
            return children;
        }
...
var AfterComponent = /** @class */ (function (_super) {
    ...
    AfterComponent.prototype.render = function () {
        var _a = this.props, initialData = _a.initialData, component = _a.component, children = _a.children, propsData = _a.data, props = __rest(_a, ["initialData", "component", "children", "data"]);
