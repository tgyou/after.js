...
export declare class MergeMapToOperator<T, I, R> implements Operator<Observable<T>, R> {
    ...
    private concurrent;
    constructor(ish: ObservableInput<I>, resultSelector?: ((outerValue: T, innerValue: I, outerIndex: number, innerIndex: number) => R) | undefined, concurrent?: number);
...
export declare class MergeMapToSubscriber<T, I, R> extends OuterSubscriber<T, I> {
    ...
    constructor(destination: Subscriber<R>, ish: ObservableInput<I>, resultSelector?: ((outerValue: T, innerValue: I, outerIndex: number, innerIndex: number) => R) | undefined, concurrent?: number);
