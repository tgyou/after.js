...
function render(options) {
    return __awaiter(this, void 0, void 0, function () {
        var req, res, routes, assets, Document, customRenderer, rest, Doc, context, renderPage, _a, match, data, reactRouterMatch, _b, html, docProps, doc;
        var _this = this;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    req = options.req, res = options.res, routes = options.routes, assets = options.assets, Document = options.document, customRenderer = options.customRenderer, rest = __rest(options, ["req", "res", "routes", "assets", "document", "customRenderer"]);
                ...
                case 1:
                    ...
                    return [4 /*yield*/, Doc.getInitialProps(__assign({ req: req,
                            ...
                            data: data, helmet: react_helmet_1.default.renderStatic(), match: reactRouterMatch }, rest))];
                case 2:
